...
#let slides(
	...
	// Subtitle, which will be displayed on the title slide in smaller font size.
	subtitle: none,
	...
	set text(font: "IBM Plex Serif", weight: "regular")
	set page(
		width: 15cm,
		height: 10cm,
	...
	page(background: none, header: none, footer: none)[
		...
		#pad(x: 16pt, emph(text(size: 16pt)[#subtitle]))
	...
	show heading: set text(font: ("IBM Plex Serif","Avenir", "Inter Display", "Inter", "Arial"))
